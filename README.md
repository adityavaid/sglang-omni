...
| **Apple Silicon** | Experimental | Qwen3-Omni runs through native MLX on macOS arm64; Qwen3-ASR retains its existing MLX/Torch-MPS support. Install with [`install.sh`](./install.sh) and follow the [Qwen3-ASR guide](./docs/cookbook/qwen3_asr.md#apple-silicon-mlx) or the [Qwen3-Omni guide](./docs/cookbook/qwen3_omni.md#apple-silicon-mlx). |
